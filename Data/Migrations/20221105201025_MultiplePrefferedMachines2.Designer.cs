...
namespace Data.Migrations
{
    ...
    [Migration("20221105201025_MultiplePrefferedMachines2")]
    partial class MultiplePrefferedMachines2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MachinePerson", b =>
                {
                    b.Property<int>("PeopleId")
                        .HasColumnType("integer");

                    b.Property<int>("PreferredMachinesId")
                        .HasColumnType("integer");

                    b.HasKey("PeopleId", "PreferredMachinesId");

                    b.HasIndex("PreferredMachinesId");

                    b.ToTable("MachinePerson");
                });
            ...
            modelBuilder.Entity("MachinePerson", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Machine", null)
                        .WithMany()
                        .HasForeignKey("PreferredMachinesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
